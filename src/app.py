...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice shooting, dribbling, and team play in competitive scrimmages",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Develop footwork, strategy, and endurance through weekly matches",
    ...
    "Drama Club": {
        "description": "Act, improvise, and perform in school plays and dramatic scenes",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore hands-on STEM projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
